...
extern OBJ_ATTR shadowOAM[128];
extern SPRITE p1;
extern SPRITE rocks[8];
extern SPRITE flowers[5];
...
void updateP1() {
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5))) && p1.worldCol >= p1.cdel) {
        p1.aniState = LEFT;
        p1.worldCol -= p1.cdel;
    }
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<4))) && p1.worldCol + p1.width - 1 < 240 - p1.cdel) {
        p1.aniState = RIGHT;
        p1.worldCol += p1.cdel;
    }
...
void drawP1() {
    if (p1.aniState == LEFT) {
        shadowOAM[shadowOAMcounter].attr0 = p1.worldRow | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = p1.worldCol | (1<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((0)*32+(10)) | ((0)<<12);
    } else {
        shadowOAM[shadowOAMcounter].attr0 = p1.worldRow | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = p1.worldCol | (1<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((0)*32+(12)) | ((0)<<12);
    }
    shadowOAMcounter++;
}
...
void drawBullets(SPRITE* b) {
    if (b->active == 1) {
        shadowOAM[shadowOAMcounter].attr0 = b->worldRow | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = b->worldCol | (0<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((2)*32+(8)) | ((0)<<12);
    } else {
...
void drawFlowers(SPRITE *f) {
    if (f->active == 1) {
        shadowOAM[shadowOAMcounter].attr0 = f->worldRow | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = f->worldCol | (0<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((24)*32+(0)) | ((0)<<12);
    } else {
        shadowOAM[shadowOAMcounter].attr0 = (2<<8);
    }
    shadowOAMcounter++;
...
void drawRocks(SPRITE *r) {
    if (r->active == 1) {
        shadowOAM[shadowOAMcounter].attr0 = r->worldRow | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = r->worldCol | (0<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((25)*32+(0)) | ((0)<<12);
    } else {
        shadowOAM[shadowOAMcounter].attr0 = (2<<8);
    }
    shadowOAMcounter++;
...
void drawInstruct() {
    if (instructions.hide == 1) {
        ...
        shadowOAM[shadowOAMcounter].attr0 = instructions.worldRow | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = instructions.worldCol | (3<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((12)*32+(8)) | ((0)<<12);
    }
    shadowOAMcounter++;
}
