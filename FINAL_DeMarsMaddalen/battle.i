...
extern SPRITE playerHearts[5];
extern SPRITE enemyHearts[5];
extern SPRITE popUp;
...
extern SPRITE enemies[3];
extern SPRITE raccoons[4];
...
extern const unsigned int heal_sound_sampleRate;
extern const unsigned int heal_sound_length;
extern const signed char heal_sound_data[];
# 7 "battle.c" 2
# 1 "hit_sound.h" 1


extern const unsigned int hit_sound_sampleRate;
extern const unsigned int hit_sound_length;
extern const signed char hit_sound_data[];
# 8 "battle.c" 2
...
SPRITE spirit;
SPRITE shaman;
SPRITE playerHearts[5];
SPRITE enemyHearts[5];
SPRITE popUp;
...
void updateFox() {
    ...
    if ((!(~(oldButtons)&((1<<0))) && (~buttons & ((1<<0)))) && enemyHeartCount > 0) {
    ...
    if ((!(~(oldButtons)&((1<<1))) && (~buttons & ((1<<1)))) && (player.heal > 0 && playerHeartCount < 5)) {
        ...
        time_s = 0;
        battleState = ENEMYTURN;
    } else if ((!(~(oldButtons)&((1<<1))) && (~buttons & ((1<<1)))) && (player.heal == 0 || playerHeartCount == 5)) {
        popUp.hide = 1;
        time_s = 0;
        battleState = ENEMYTURN;
    }
...
void drawFox() {
    if (foxHit > 0) {
        shadowOAM[shadowOAMcounter].attr0 = fox.worldRow | (0<<14) | (1<<12);
    } else {
        shadowOAM[shadowOAMcounter].attr0 = fox.worldRow | (0<<14);
    }
    shadowOAM[shadowOAMcounter].attr1 = fox.worldCol | (1<<14);
    shadowOAM[shadowOAMcounter].attr2 = ((fox.curFrame * 2)*32+(2)) | ((0)<<12);
    shadowOAMcounter++;
}
...
void drawSpirit() {
    if (enemyHit > 0) {
        ...
        shadowOAM[shadowOAMcounter].attr0 = spirit.worldRow | (0<<14) | (1<<12);
    } else {
        shadowOAM[shadowOAMcounter].attr0 = spirit.worldRow | (0<<14);
    }
    shadowOAM[shadowOAMcounter].attr1 = spirit.worldCol | (1<<14);
    shadowOAM[shadowOAMcounter].attr2 = ((20)*32+(spirit.curFrame * 2)) | ((0)<<12);
    shadowOAMcounter++;
}
...
void drawHearts() {
    for (int i = 0; i < 5; i++) {
        if (playerHearts[i].active == 0) {
            shadowOAM[shadowOAMcounter].attr0 = (2<<8);
        } else {
            shadowOAM[shadowOAMcounter].attr0 = playerHearts[i].worldRow | (0<<14);
            shadowOAM[shadowOAMcounter].attr1 = playerHearts[i].worldCol | (0<<14);
            shadowOAM[shadowOAMcounter].attr2 = ((0)*32+(playerHearts[i].curFrame + 8)) | ((0)<<12);
        }
        shadowOAMcounter++;
    }
    ...
    for (int i = 0; i < 5; i++) {
        if (enemyHearts[i].active == 0) {
            ...
            shadowOAM[shadowOAMcounter].attr0 = enemyHearts[i].worldRow | (0<<14);
            shadowOAM[shadowOAMcounter].attr1 = enemyHearts[i].worldCol | (0<<14);
            shadowOAM[shadowOAMcounter].attr2 = ((1)*32+(enemyHearts[i].curFrame + 8)) | ((0)<<12);
        }
        shadowOAMcounter++;
    }
}
...
void drawPopUp() {
    if (popUp.hide == 0) {
        ...
        shadowOAM[shadowOAMcounter].attr0 = popUp.worldRow | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = popUp.worldCol | (3<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((12)*32+(0)) | ((0)<<12);
    }
    shadowOAMcounter++;
}
...
void drawFinalBattle() {
    ...
    if (instructions3 == 0) {
        ...
        shadowOAM[shadowOAMcounter].attr0 = 50 | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = 90 | (3<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((24)*32+(8)) | ((0)<<12);
    }
    shadowOAMcounter++;
...
void updateFox2() {
    ...
    if ((!(~(oldButtons)&((1<<1))) && (~buttons & ((1<<1)))) && enemyHeartCount > 0) {
        fox.aniState = DANCE2;
        fox.aniCounter++;
        enemyHearts[enemyHeartCount - 1].active = 0;
        enemyHeartCount--;
    ...
    if ((!(~(oldButtons)&((1<<8))) && (~buttons & ((1<<8)))) && enemyHeartCount > 0) {
        fox.aniState = DANCE3;
        fox.aniCounter++;
...
void drawFox2() {
    shadowOAM[shadowOAMcounter].attr0 = fox.worldRow | (0<<14);
    shadowOAM[shadowOAMcounter].attr1 = fox.worldCol | (1<<14);
    shadowOAM[shadowOAMcounter].attr2 = ((fox.curFrame * 2)*32+((fox.aniState * 2) + 18)) | ((0)<<12);
    shadowOAMcounter++;
}
...
void drawShaman() {
    shadowOAM[shadowOAMcounter].attr0 = shaman.worldRow | (0<<14);
    shadowOAM[shadowOAMcounter].attr1 = shaman.worldCol | (2<<14);
    shadowOAM[shadowOAMcounter].attr2 = ((shaman.curFrame * 4)*32+(14)) | ((0)<<12);
    shadowOAMcounter++;
}
...
void setupBattleInterrupts(void) {
    *(unsigned short*)0x4000208 = 0;
    *((ihp*)0x03007FFC) = battleInterruptHandler;
...
void drawTimer() {
    if (battleState == PLAYERTURN) {
        ((screenblock *)0x6000000)[28].tilemap[((19)*(32)+(6))] = 31 - time_s;
    } else {
        ((screenblock *)0x6000000)[28].tilemap[((19)*(32)+(6))] = 11;
    }
    shadowOAMcounter++;
}
...
void drawTimer2() {
    if (battleState == PLAYERTURN) {
        ((screenblock *)0x6000000)[28].tilemap[((19)*(32)+(6))] = 7 + time_s;
    } else {
        ((screenblock *)0x6000000)[28].tilemap[((19)*(32)+(6))] = 7 + 20;
    }
    shadowOAMcounter++;
}
