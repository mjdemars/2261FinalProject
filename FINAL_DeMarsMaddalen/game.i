...
void updatePlayer() {
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) {
        if (player.worldCol > 0 && collisionCheck(collisionMap, 512, player.worldCol, player.worldRow, player.width, player.height, -player.cdel, 0)) {
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
        if (player.worldCol + player.width < 512 && collisionCheck(collisionMap, 512, player.worldCol, player.worldRow, player.width, player.height, player.cdel, 0)) {
            player.worldCol += player.cdel;
            if ((hOff < 512 - 240) && ((player.worldCol - hOff) > 240 / 2)) {
                if (player.cheat == 0) {
                    hOff++;
                } else {
                    hOff += 2;
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<6)))) {
        if (player.worldRow > 0 && collisionCheck(collisionMap, 512, player.worldCol, player.worldRow, player.width, player.height, 0, -player.rdel)) {
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<7)))) {
        if (player.worldRow + player.height < 512 && collisionCheck(collisionMap, 512, player.worldCol, player.worldRow, player.width, player.height, 0, player.rdel)) {
            player.worldRow += player.rdel;
            if ((vOff < 512 - 160) && ((player.worldRow - vOff) > 160 / 2)) {
                if (player.cheat == 0) {
                    vOff++;
                } else {
                    vOff += 2;
    ...
    if ((!(~(oldButtons)&((1<<2))) && (~buttons & ((1<<2))))) {
        if (collisionCheck(collisionMap, 512, player.worldCol, player.worldRow, player.width, player.height, 0, 0) == 1) {
            player.cheat = 1;
            player.heal = 5;
            player.rdel = 2;
            player.cdel = 2;
...
void drawPlayer() {
    shadowOAM[shadowOAMcounter].attr0 = (0xFF & (player.worldRow - vOff)) | (0<<14);
    shadowOAM[shadowOAMcounter].attr1 = (0x1FF & (player.worldCol - hOff)) | (1<<14);
    shadowOAM[shadowOAMcounter].attr2 = ((player.curFrame * 2)*32+(player.aniState * 2)) | ((0)<<12);
    shadowOAMcounter++;
}
...
void drawEnemies(SPRITE *e) {
    if ((e->worldRow + e->height - vOff >= 0)
            ...
            && (e->worldCol - hOff <= 240)) {
        shadowOAM[shadowOAMcounter].attr0 = (0xFF & (e->worldRow - vOff)) | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = (0x1FF & (e->worldCol - hOff)) | (2<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((8)*32+((e->curFrame * 4))) | ((0)<<12);
    }
    shadowOAMcounter++;
}
...
void drawRaccoons(SPRITE *r) {
    if ((r->worldRow + r->height - vOff >= 0)
        ...
        if (r->hide == 1) {
            ...
            shadowOAM[shadowOAMcounter].attr0 = (0xFF & (r->worldRow - vOff)) | (0<<14);
            shadowOAM[shadowOAMcounter].attr1 = (0x1FF & (r->worldCol - hOff)) | (1<<14);
            if (r->num == 0 || r->num == 3) {
                shadowOAM[shadowOAMcounter].attr2 = ((22)*32+((r->curFrame * 2))) | ((0)<<12);
            } else if (r->num == 1) {
                shadowOAM[shadowOAMcounter].attr2 = ((22)*32+((r->curFrame * 2) + 4)) | ((0)<<12);
            } else if (r->num == 2) {
                shadowOAM[shadowOAMcounter].attr2 = ((22)*32+((r->curFrame * 2) + 8)) | ((0)<<12);
            }
        }
    }
    shadowOAMcounter++;
...
void drawFinalBoss() {
    if ((finalBoss.worldRow + finalBoss.height - vOff >= 0)
            && (finalBoss.worldRow - vOff <= 160)
            && (finalBoss.worldCol + finalBoss.width - hOff >= 0)
            && (finalBoss.worldCol - hOff <= 240)) {
        shadowOAM[shadowOAMcounter].attr0 = (0xFF & (finalBoss.worldRow - vOff)) | (0<<14);
        shadowOAM[shadowOAMcounter].attr1 = (0x1FF & (finalBoss.worldCol - hOff)) | (2<<14);
        shadowOAM[shadowOAMcounter].attr2 = ((8)*32+((finalBoss.curFrame * 4) + 8)) | ((0)<<12);
    }
    shadowOAMcounter++;
}
